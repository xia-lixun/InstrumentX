...
#define semCPU0CPU1    (*(volatile unsigned long *)(0xFFFF0000))
...
#define semMBCPU1    (*(volatile u32 *)(0xFFFF0004))
...
int main(int argc, char** argv) {
    ...
    while(1){
    	...
    	while(semMBCPU1 == 0) {};
    	print("CPU1: <-MB\n\r");
    	rs255239_encode((uint8_t *)shmMBCPU1+1);
    	//form the code word
    	for(int k = 239; k < 255; k++) {
    		*(shmMBCPU1+k+1) = x[k];
    	}
