...
void test_memory_range(struct memory_range_s *range) {
    ...
    status = Xil_TestMem32((u32*)range->base, 510*1024*256, 0xAAAA5555, XIL_TESTMEM_ALLMEMTESTS);
    print("          32-bit test: "); print(status == XST_SUCCESS? "PASSED!":"FAILED!"); print("\n\r");

    status = Xil_TestMem16((u16*)range->base, 510*1024*512, 0xAA55, XIL_TESTMEM_ALLMEMTESTS);
    print("          16-bit test: "); print(status == XST_SUCCESS? "PASSED!":"FAILED!"); print("\n\r");

    status = Xil_TestMem8((u8*)range->base, 510*1024*1024, 0xA5, XIL_TESTMEM_ALLMEMTESTS);
